// ignore_for_file: unnecessary_null_comparison, use_super_parameters, unnecessary_cast, prefer_const_constructors, camel_case_types, deprecated_member_use, use_build_context_synchronously, unused_local_variable, avoid_print
...
class _FormsState extends State<Forms> {
  ...
  Future<String?> uploadPDF(String fileName, File file) async {
    final ref = FirebaseStorage.instance.ref().child("Forms/$fileName.pdf");
  ...
  void pickFile() async {
    ...
    if (pickedFile != null) {
      ...
      await _firebaseFirestore.collection("Forms").add({
        "name": fileName,
        "url": downloadLink,
  ...
  void getPDF() async {
    final result = await _firebaseFirestore.collection("Forms").get();
    setState(() {
