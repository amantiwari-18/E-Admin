// ignore_for_file: unnecessary_null_comparison, file_names, use_super_parameters, unnecessary_cast, camel_case_types, use_build_context_synchronously
...
class OfficialOrder extends StatefulWidget {
  const OfficialOrder({Key? key}) : super(key: key);

  @override
  State<OfficialOrder> createState() => _OfficialOrderState();
}

class _OfficialOrderState extends State<OfficialOrder> {
  ...
  Future<String?> uploadPDF(String fileName, File file) async {
    final ref = FirebaseStorage.instance.ref().child("Official Order/$fileName.pdf");
  ...
  void pickFile() async {
    ...
    if (pickedFile != null) {
      ...
      await _firebaseFirestore.collection("Official Order").add({
        "name": fileName,
        "url": downloadLink,
  ...
  void getPDF() async {
    final result = await _firebaseFirestore.collection("Official Order").get();
    setState(() {
      ...
      children: [
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Padding(
            ...
            child: InkWell(onTap: ()async{                           Map<Permission, PermissionStatus> statuses = await [
                    Permission.storage,
                  ].request();
