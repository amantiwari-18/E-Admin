// ignore_for_file: avoid_print, unnecessary_null_comparison, unnecessary_cast, use_super_parameters, use_build_context_synchronously
...
class _NoticeState extends State<Notice> {
 ...
 List<Map<String, dynamic>> pdfData = [];
  ...
  Future<String?> uploadPDF(String fileName, File file) async {
    final ref = FirebaseStorage.instance.ref().child("Notice/$fileName.pdf");
  ...
  void pickFile() async {
    ...
    if (pickedFile != null) {
      ...
      await _firebaseFirestore.collection("Notice").add({
        "name": fileName,
        "url": downloadLink,
  ...
  void getPDF() async {
    final result = await _firebaseFirestore.collection("Notice").get();
    setState(() {
